...
public class MsbRegistration {
    ...
    private void unRegister() {
        ...
        try {
            ...
            RestfulResponse response = RestfulUtil.getRemoteResponse(paramsMap, null, null); //.delete(url, restParametes);
    ...
    private class RegisterThread implements Runnable {
        ...
        private void sendRequest(RestfulParametes restParametes)  {
			...
			RestfulResponse response = RestfulUtil.getRemoteResponse(paramsMap, rawData, null);//(paramsMap, restParametes);
			if(isSuccess(response.getStatus())) {
